...
function extractFacts(userText, assistantText) {
    const facts = [];
...
export function buildCaptureHandler(client, cfg) {
    return async (event) => {
        ...
        if (userText.length > 50) {
            ...
            await client.addMemory(`User discussed: ${summary}`, "context", "auto-capture");
        }
    };
}
