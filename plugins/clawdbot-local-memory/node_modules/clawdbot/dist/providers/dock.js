...
import { resolveDiscordGroupRequireMention, resolveIMessageGroupRequireMention, resolveSlackGroupRequireMention, resolveTelegramGroupRequireMention, resolveWhatsAppGroupRequireMention, } from "./plugins/group-mentions.js";
...
export function listProviderDocks() {
    return CHAT_PROVIDER_ORDER.map((id) => DOCKS[id]);
}
export function getProviderDock(id) {
    return DOCKS[id];
}
