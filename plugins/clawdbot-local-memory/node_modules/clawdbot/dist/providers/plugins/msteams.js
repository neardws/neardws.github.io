...
export const msteamsPlugin = {
    ...
    config: {
        ...
        isConfigured: (_account, cfg) => Boolean(resolveMSTeamsCredentials(cfg.msteams)),
    ...
    outbound: {
        ...
        resolveTarget: ({ to }) => {
            ...
            if (!trimmed) {
                return {
                    ok: false,
                    error: new Error("Delivering to MS Teams requires --to <conversationId|user:ID|conversation:ID>"),
                };
            }
