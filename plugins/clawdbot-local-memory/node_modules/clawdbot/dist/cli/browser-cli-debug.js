...
import { browserHighlight, browserPageErrors, browserRequests, browserTraceStart, browserTraceStop, } from "../browser/client-actions.js";
...
export function registerBrowserDebugCommands(browser, parentOpts) {
    browser
        .command("highlight")
    ...
    browser
        ...
        await runBrowserDebug(async () => {
            ...
            defaultRuntime.log(result.errors
    ...
    browser
        ...
        await runBrowserDebug(async () => {
            ...
            defaultRuntime.log(result.requests
                .map((r) => {
