	...
	<table style="margin-left: auto; margin-right: auto;">
		<tr>
			<td>
				...
				E-mail:   
				<a href="mailto:xc.xu@uestc.edu.cn" class="no-underline:hover">xc.xu@uestc.edu.cn</a> | 
				<a href="mailto:neard.ws@gmail.com" class="no-underline:hover">neard.ws@gmail.com</a>
			</td>
			<td>
